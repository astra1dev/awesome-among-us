...
- [AmongUsMonoAssemblies](https://github.com/astra1dev/AmongUsMonoAssemblies) - contains latest Mono .dll files. automatically generates diffs so you can easily compare game versions to see what has changed
